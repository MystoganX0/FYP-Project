...
<body class="font-poppins bg-pattern min-h-screen flex items-center justify-center p-4">
    ...
    <div
        ...
        <!-- Left Side: Visual -->
        <div
            class="hidden md:flex md:w-5/12 bg-gradient-to-br from-primary to-blue-900 p-8 flex-col justify-between relative overflow-hidden text-white">
            ...
            <div class="relative z-10">
                ...
                <p class="text-blue-100/80 text-sm">Join our driving academy and start your journey towards safe
                    driving.</p>
            </div>
            ...
            <div class="relative z-10 text-center">
                ...
                <a href="{{ route('home') }}"
                    class="inline-block mt-2 px-6 py-2 rounded-full border border-white/30 hover:bg-white hover:text-primary transition-all duration-300 text-sm font-medium">
                    Sign In instead
                </a>
            </div>
        </div>
        ...
        <div class="w-full md:w-7/12 p-8 md:p-12 bg-white/50 md:bg-white">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div class="group">
                    <label
                        class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Username</label>
                    <div
                ...
                <!-- Email -->
                <div class="group">
                    <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Email
                        Address</label>
                    <div
                        class="relative transition-all duration-300 focus-within:transform focus-within:-translate-y-1">
                        <span
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="group">
                        <label
                            class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Password</label>
                        <div
                            class="relative transition-all duration-300 focus-within:transform focus-within:-translate-y-1">
                            <span
                                class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 group-focus-within:text-primary transition-colors">
                    ...
                    <div class="group">
                        <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Confirm
                            Password</label>
                        <div
                            class="relative transition-all duration-300 focus-within:transform focus-within:-translate-y-1">
                            <span
                ...
                <!-- Submit Button -->
                <button type="submit"
                    class="w-full bg-gradient-to-r from-primary to-blue-700 text-white font-bold py-4 rounded-xl hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 mt-4 flex items-center justify-center gap-2 group">
