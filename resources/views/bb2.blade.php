...
<body class="font-poppins bg-gray-100 text-white">
    ...
    <section class="w-full flex flex-col lg:flex-row gap-4 md:gap-8 py-4 md:py-6 px-4 md:px-8 lg:px-12 xl:px-48 mb-10">
        <div id="formSection" class="w-full min-w-0 bg-white rounded-3xl p-8 text-black shadow-2xl ">
            ...
            <form id="registrationForm" class="space-y-5 text-base px-2 md:px-6 lg:px-8">
                ...
                <div class="flex justify-center">
                    <div class="border border-blue-900 rounded-lg px-10 py-1 bg-blue-100 text-blue-900 text-center">
                        You need to verify the information first before you can apply
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul class="grid w-full gap-4 md:grid-cols-2 items-stretch">
                        ...
                        <li class="relative">
                            ...
                            <label for="payment-full" class="h-full inline-flex flex-col justify-between w-full p-4 text-base text-gray-800 
                       bg-white border-4 border-gray-200 rounded-xl cursor-pointer transition-all duration-200
                       peer-checked:border-3 peer-checked:border-blue-500 peer-checked:bg-blue-100 
                       hover:border-blue-300 hover:bg-white relative">
                                ...
                                <div class="block">
                                    ...
                                    <div class="w-full text-base font-semibold pt-2">Stage 1 : RM 1599</div>
                                </div>
                            </label>
                        </li>
                        ...
                        <li class="relative">
                            ...
                            <label for="payment-installment"
                                class="h-full inline-flex flex-col justify-between w-full p-4 text-base text-gray-800 bg-white border-4 border-gray-200 rounded-xl 
                            cursor-pointer transition-all duration-200 peer-checked:border-3 peer-checked:border-blue-500 peer-checked:bg-blue-100 hover:border-blue-300 hover:bg-white relative">
                                ...
                                <div class="block">
                                    ...
                                    <div class="w-full text-base font-semibold pt-2">Stage 1 : RM 800</div>
                                    <div class="w-full text-base font-semibold">Stage 2 : RM 500</div>
                                    <div class="w-full text-base font-semibold">Stage 3 : RM 500</div>
                                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="w-full">
                        ...
                        <input id="myKad" type="file" aria-describedby="myKad_help" class="block w-full text-base font-medium text-black border border-gray-300 rounded-xl cursor-pointer 
            ...
            <div
                ...
                <div class="relative flex flex-col items-center justify-center gap-6 text-center">
                    <div class="flex flex-col items-center gap-3">
                        <div>
                            <h3 class="text-xl font-semibold text-gray-100 uppercase tracking-wider">Stage 1</h3>
                    ...
                    <div class="flex items-start justify-center">
                        ...
                        <span class="text-6xl font-extrabold tracking-tighter text-white drop-shadow-lg">1599</span>
                    </div>
                </div>
            </div>

            <button id="apply" type="button" disabled
                class="w-full group relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white transition-all duration-200 bg-gradient-to-r from-blue-500 to-blue-400 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 hover:shadow-lg hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:shadow-none">
                <span id="btnText">Apply Now</span>
            </button>

            <button id="verify" type="button"
                class="w-full group relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white transition-all duration-200 bg-gradient-to-r from-blue-900 to-blue-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-900 hover:shadow-lg hover:-translate-y-0.5">
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            verifyBtn.addEventListener("click", async () => {
                ...
                if (myKad.files.length) {
                    ...
                    resultsDiv.innerHTML = `<div class="flex flex-col items-center gap-2 py-3"><div class="loader"></div><span class="mt-8 text-green-600">Checking MyKad with OCR...</span></div>`;
