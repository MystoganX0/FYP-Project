                    ...
                    <section class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div
                            ...
                            <div class="flex justify-between items-start">
                                ...
                                <span
                                    class="text-xs font-semibold text-purple-600 bg-purple-50 px-2 py-1 rounded-full">B
                                    &
                                    B2</span>
                            </div>
                            <div>
                            ...
                            <table class="w-full text-base text-center text-gray-600">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    <tr class="hover:bg-gray-50/80 transition-colors group">
                                        <td class="p-4">
                                            <div class="h-16 w-16 mx-auto flex items-center justify-center border">
                                                <img src="/image/classes/b.png" class="h-16 object-contain"
                                                    alt="Class B">
                                            </div>
                                        </td>
                                        <td class="px-6 py-4">
